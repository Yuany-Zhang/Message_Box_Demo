...
<title>确认账号/confirmAccount</title>
</head>
<body>
	<%
		...
		try{
		    ...
		    if(rs.next()){ 
		     ...
		     %> 
		    <h1 style="text-align:center;">账号 <% out.println(accountName); %> 登录成功，三秒后自动跳转到用户主界面</h1>
			<h5 style="text-align:center;">
			<input type="button" value="点击这里直接跳转" onclick="window.location.href = 'Welcome.jsp'"> </h5>
			<%
